...
function mostrarFormularioPesquisa(tabela, txt){
    ...
    var data = "<div class='row' style='margin-top:5%'>";
           data += "<div class='medium-10 large-10 small-10 small-centered medium-centered large-centered columns'>";
                if (txt != undefined)
            ...
            data += "<div class='medium-4 medium-offset-1 large-3 large-offset-1 small-6 small-offset-1 columns'>";
         ...
         data += "<div class='medium-4 large-4 small-4 columns'>";
            data += "<input type='button' id='btPesquisarPerguntas' value='pesquisar' class='hollow button'/>";
        data += "</div>";
    data += "</div>";
