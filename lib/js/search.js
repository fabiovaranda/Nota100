...
function mostrarFormularioPesquisa(tabela, txt){
    var data = "<div class='row'>";
            ...
            data += "</div>";
             data += "</div>";
     data += "<div class='row'>";
        data += "<div class='medium-10 medium-centered large-10 large-centered small-10 small-centered columns'>";
                if (txt != undefined)
            ...
            data += "</div>";
            data += "<div class='medium-4 medium-offset-1 large-4 large-offset-1 small-10 small-centered columns'>";
        ...
        data += "</div>";
        data += "<div class='medium-1 columns'>&nbsp;</div>";
    data += "</div>";
