...
function corrigirPergunta(){
    //SpinnerDialog.show();  
    alert('r1 checked' + document.getElementById('resposta1').checked);
    ...
    dbb.executeSql(query,[],function(res){
        ...
        alert('response error: ' + err.message);s
    });
...
function mostrarCorrecao(respostaUtilizador, respostaCorreta, id){
    var query = "select * from perguntas where id = "+ id;
    var RU;
    dbb.executeSql(query, [], function(res) {
        ...
        alert("ru " + RU);    
        var RC = res.rows.item(0).respostaCorreta;
        ...
        data += "<div class='row'>";
                data +="<div class='small-12 medium-12 columns'>";
                    data += " <font color='red'> " + RU + "</font>";
                data +="</div>";
        data +="</div>";
        data += "<div class='row'>";
                data +="<div class='small-12 medium-12 columns'>";
                    data += " <font color='green'> " + RC + "</font>";
                data +="</div>";
        data +="</div>";
    ...
    dbb.executeSql(query, [], function(result) {
        ...
        dbb.executeSql(query, [], function(res) {
            ...
            if (acertou == 1){
                data = "<div class='row'>";
                    data +="<div class='small-12 medium-12 columns'>";
                        data += "<div data-alert class='alert-box info radius'>Resposta Correta!</div>";
                    data +="</div>";
                data +="</div>";    
            }
            ...
            data += "<div class='row' style='background: rgba(147,206,222,1);
                background: -moz-linear-gradient(left, rgba(147,206,222,1) 0%, rgba(117,189,209,0.9) 41%, rgba(0,140,186,0.75) 100%);
                background: -webkit-gradient(left top, right top, color-stop(0%, rgba(147,206,222,1)), color-stop(41%, rgba(117,189,209,0.9)), color-stop(100%, rgba(0,140,186,0.75)));
                background: -webkit-linear-gradient(left, rgba(147,206,222,1) 0%, rgba(117,189,209,0.9) 41%, rgba(0,140,186,0.75) 100%);
                background: -o-linear-gradient(left, rgba(147,206,222,1) 0%, rgba(117,189,209,0.9) 41%, rgba(0,140,186,0.75) 100%);
                background: -ms-linear-gradient(left, rgba(147,206,222,1) 0%, rgba(117,189,209,0.9) 41%, rgba(0,140,186,0.75) 100%);
                background: linear-gradient(to right, rgba(147,206,222,1) 0%, rgba(117,189,209,0.9) 41%, rgba(0,140,186,0.75) 100%);
                filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#93cede', endColorstr='#008cba', GradientType=1 );'>";
                    data +="<div class='small-12 medium-12 columns'>";
            ...
            data += "<div class='row'>";
                    ...
                    data +="</div>";
            data +="</div>";
            data += "<div class='row' style='background-color:#008CBA; opacity:0.5'>";
                    data +="<div class='small-12 medium-12 columns'>";
