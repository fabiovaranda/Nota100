    ...
    db.executeSql(query, [], function(res) {
        ...
        data += "<div class='row'>";
                data +="<div class='small-12 medium-12 columns'>";
                    ...
                    data += "<br/><center><input type='button' class='small round button' value='Próxima Questão' onclick='nextQuestion()'/></center>";
                data +="</div>";
        data +="</div>";
...
$('#perguntasFutebol').click(function(){  
   dbb = db;
   alert(HaPerguntasNaTabela(dbb,"perguntas"));
   if ( HaPerguntasNaTabela(dbb,"perguntas") == false )
...
$('#perguntasFutebolIng').click(function(){  
   dbb = db;
   if ( HaPerguntasNaTabela(dbb,"perguntasIngles") == false )
    alert('Deve atualizar a base de dados da sua app antes de pesquisar por perguntas');
   else
...
$('#perguntasFutsal').click(function(){  
   dbb = db;
   if ( HaPerguntasNaTabela(dbb,"perguntasFutsal") == false )
    alert('Deve atualizar a base de dados da sua app antes de pesquisar por perguntas');
   else
