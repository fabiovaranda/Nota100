...
function formUpdate(){
    var data = "<div class='row'>";
            ...
            data += "</div>";
             data += "</div>";
     data += "<div class='row'>";
     	    data += "<div class='medium-3 medium-offset-3 small-12 columns'><center>";
                ...
                data += "</select>";
            data += "</center></div>";            
        data += "<div class='medium-6 small-12 columns'><center>";
...
function updateTables(){
    ...
    var request = $.ajax({
        ...
        error: function(err){
        	SpinnerDialog.hide();
            alert(" Error. No network connection. " + eval(err.status));
        }
